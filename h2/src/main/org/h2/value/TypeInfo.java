...
public class TypeInfo extends ExtTypeInfo implements Typed {
    ...
    /**
     * URL type with maximum parameters.
     */
    public static final TypeInfo TYPE_URL;
    ...
    static {
        ...
        infos[Value.URL] = TYPE_URL = new TypeInfo(Value.URL);
        // BINARY
    ...
    public static TypeInfo getTypeInfo(int type, long precision, int scale, ExtTypeInfo extTypeInfo) {
        ...
        case Value.URL:
            ...
            return new TypeInfo(Value.URL, precision);
        case Value.BINARY:
            if (precision < 1) {
                return TYPE_BINARY;
            }
